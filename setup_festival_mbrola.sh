...
install_festival() {
  ...
  download_uncompress_festival_package "$R" "$REPO" "$BUILD" "http://festvox.org/packed/festival/2.5/speech_tools-2.5.0-release.tar.gz"
  download_uncompress_festival_package "$R" "$REPO" "$BUILD" "http://festvox.org/packed/festival/2.5/festival-2.5.0-release.tar.gz"
  download_uncompress_festival_package "$R" "$REPO" "$BUILD" "http://festvox.org/packed/festival/2.5/festlex_CMU.tar.gz"
  download_uncompress_festival_package "$R" "$REPO" "$BUILD" "http://festvox.org/packed/festival/2.5/festlex_OALD.tar.gz"
  download_uncompress_festival_package "$R" "$REPO" "$BUILD" "http://festvox.org/packed/festival/2.5/festlex_POSLEX.tar.gz"

  REPO="download_festival_voices"
  download_uncompress_festival_package "$R" "$REPO" "$BUILD" "http://festvox.org/packed/festival/2.5/voices/festvox_kallpc16k.tar.gz"
  download_uncompress_festival_package "$R" "$REPO" "$BUILD" "http://festvox.org/packed/festival/2.5/voices/festvox_rablpc16k.tar.gz"
...
install_festival_voices() {
  ...
  declare -a URLS=(
    ...
    "http://festvox.org/packed/festival/2.5/voices/festvox_cmu_us_ahw_cg.tar.gz"
    "http://festvox.org/packed/festival/2.5/voices/festvox_cmu_us_aup_cg.tar.gz"
    "http://festvox.org/packed/festival/2.5/voices/festvox_cmu_us_awb_cg.tar.gz"
    "http://festvox.org/packed/festival/2.5/voices/festvox_cmu_us_axb_cg.tar.gz"
    "http://festvox.org/packed/festival/2.5/voices/festvox_cmu_us_bdl_cg.tar.gz"
    "http://festvox.org/packed/festival/2.5/voices/festvox_cmu_us_clb_cg.tar.gz"
    "http://festvox.org/packed/festival/2.5/voices/festvox_cmu_us_fem_cg.tar.gz"
    "http://festvox.org/packed/festival/2.5/voices/festvox_cmu_us_gka_cg.tar.gz"
    "http://festvox.org/packed/festival/2.5/voices/festvox_cmu_us_jmk_cg.tar.gz"
    "http://festvox.org/packed/festival/2.5/voices/festvox_cmu_us_ksp_cg.tar.gz"
    "http://festvox.org/packed/festival/2.5/voices/festvox_cmu_us_rms_cg.tar.gz"
    "http://festvox.org/packed/festival/2.5/voices/festvox_cmu_us_rxr_cg.tar.gz"
    "http://festvox.org/packed/festival/2.5/voices/festvox_cmu_us_slt_cg.tar.gz"
    "http://festvox.org/packed/festival/2.5/voices/festvox_kallpc16k.tar.gz"
    "http://festvox.org/packed/festival/2.5/voices/festvox_rablpc16k.tar.gz"
  )
  for URL in "${URLS[@]}"
  do
